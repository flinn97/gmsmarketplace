...
class TextBoxComponent extends Component {
    ...
    render() {
        ...
        return (
            <div ref={this.wrapperRef} style={this.props.wrapperStyle?this.props.wrapperStyle:theme!==undefined? theme.textBoxWrapperStyle:undefined} className={this.props.wrapperClass}>
